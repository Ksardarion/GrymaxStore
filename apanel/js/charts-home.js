...
$(document).ready(function () {
    ...
    function getDataFromAjax(require){
        $.ajax({
            type: "POST",
            url: "/apanel/ajax/getDataForCharts.ajax.php",
    ...
    getDataFromAjax('visitors');

    function createChart(data){
        function makeDaysArray(daysNumber){
            var arr = [];
        ...
        function getMaxOfVisitors(arr1, arr2){
            var arr3 = arr1.concat(arr2);
            return Math.max.apply(Math, arr3);
        ...
        var myLineChart = new Chart(LINECHART, {
            ...
            options: {
                scales: {
                    ...
                    yAxes: [{
                        ticks: {
                            max: 10 + getMaxOfVisitors(Object.values(data[0]), Object.values(data[1])),
                            min: 0
                        },
                        display: true,
                        gridLines: {
    ...
    // var dataForChart = getDataFromAjax('visitors');
