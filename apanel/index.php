              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-user-1"></i></div><strong>New Clients Of Mounth</strong>
                    </div>
                    <div class="number dashtext-1"><?=grymaxShop::getCurrentMounthData('users')?></div>
                  </div>
<!--                  <div class="progress">-->
...
<!--                  </div>-->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>New Orders Of Mounth</strong>
                    </div>
                    <div class="number dashtext-2"><?=grymaxShop::getCurrentMounthData('orders')?></div>
                  </div>
<!--                  <div class="progress">-->
...
<!--                  </div>-->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>New Articles Of Mounth</strong>
                    </div>
                    <div class="number dashtext-3"><?=grymaxShop::getCurrentMounthData('articles')?></div>
                  </div>
<!--                  <div class="progress">-->
...
<!--                  </div>-->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>All Articles In System</strong>
                    </div>
                    <div class="number dashtext-4"><?=grymaxShop::getCountFromTable('articles')?></div>
                  </div>
<!--                  <div class="progress">-->
